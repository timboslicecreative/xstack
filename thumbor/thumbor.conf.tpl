...
TC_AWS_ENDPOINT = '{{ TC_AWS_ENDPOINT | default('') }}' # Custom S3 endpoint URL (for GCP, Minio, etc.)
if TC_AWS_ENDPOINT == '':
...
SPACES_REGION = '{{ SPACES_REGION | default('') }}'

SPACES_ENDPOINT = '{{ SPACES_ENDPOINT | default('') }}'

SPACES_KEY = '{{ SPACES_KEY | default('') }}'

SPACES_SECRET = '{{ SPACES_SECRET | default('') }}'

SPACES_BUCKET = '{{ SPACES_BUCKET | default('') }}'

SPACES_ACL = '{{ SPACES_ACL | default('public') }}'

SPACES_RESULT_FOLDER = '{{ SPACES_RESULT_FOLDER | default('') }}'

SPACES_LOADER_FOLDER = '{{ SPACES_LOADER_FOLDER | default('') }}'
